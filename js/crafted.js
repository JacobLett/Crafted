...
// ==========================================================================
	...
	// Image crop Settings
	if ( craftedImageCrop === true) {
	    // variable is true
		//console.log('craftedImageCrop' + craftedImageCrop);
		
		$('.ProductList .list-item .ProductImage, .ProductList .ProductImage, .productPage .ProductList .ProductImage, .crafted .ProductList .ProductImage, .crafted #ProductDetails .ProductThumbImage').addClass('crop');
	...
	// Crafted Top Nav Settings
	if (typeof craftedTopNav === 'undefined') {
	    // variable is undefined
		//console.log('craftedTopNav undefined');
	} else if (craftedTopNav == 'pages') {
		//console.log('craftedTopNav' + craftedTopNav);
		$("#home .header .PageMenu .CategoryList, #DrawerMenu .CategoryList").hide();
		$("#home .header .PageMenu .pages-menu, #DrawerMenu .pages-menu").show();
		
	} else if (craftedTopNav == 'categories') {
		//console.log('craftedTopNav' + craftedTopNav);
		$("#home .header .PageMenu .CategoryList, #DrawerMenu .CategoryList").show();
		$("#home .header .PageMenu .pages-menu, #DrawerMenu .pages-menu").hide();
		
	} else if (craftedTopNav == 'both') {
		//console.log('craftedTopNav' + craftedTopNav);
		$("#home .header .PageMenu .CategoryList, #DrawerMenu .CategoryList").show();
		$("#home .header .PageMenu .pages-menu, #DrawerMenu .pages-menu").show();
		$("#home .header .PageMenu").addClass('both');
	}
	
	
	// Crafted Top Nav Font Size Adjustment
	if (typeof craftedTopNavFontSize === 'undefined') {
	    // variable is undefined
		//console.log('craftedTopNavFontSize undefined');
	} else {
		//console.log('craftedTopNavFontSize' + craftedTopNavFontSize);
		$(".header .sf-menu a").css("font-size", craftedTopNavFontSize).css("line-height", craftedTopNavLineHeight);
	} 
...
if ($("#SideCurrencySelector").length){ 
...
// ==========================================================================
	...
	if(typeof GLOBAL_SwapFrequency === 'undefined'){
	   // your code here.
...
// ==========================================================================	
	...
	// Adds sale tag to product list if on sale
	if ($('.ProductList .SalePrice').length) { // implies *not* zero
		//console.log('on sale so add sale tag to product list');
	...
	if ($('.productPage .p-price .s-price:contains("save")').length) { // implies *not* zero
		//console.log('product for sale so show sale tag');
		$('.ProductThumbImage').append( "<span class='saleTag'>Sale</span>" );
	  }
	
	// If product is pre-order do remove the sale price
	if ($('.productPage .ProductMain .ExpectedReleaseDate').length) { // implies *not* zero
		//console.log('presale so remove sale tag');
		$('.ProductThumbImage .saleTag').remove();
		$('.ProductMain .p-price .YouSave').remove();
		$('.ProductMain .p-price strike').replaceWith('<span class="preorder">Pre-Order</span>');
	  }
